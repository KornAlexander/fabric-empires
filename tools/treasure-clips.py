...
⚠️ Run from anywhere; it writes to the repo's media folder. The clips are
SOURCE MATERIAL, not build output: regenerating them costs money and returns a
different film, so they are kept and copied into app/public, never rebuilt as
...
HOST = "https://alkorn-6245-resource.openai.azure.com"
MODEL = "sora-2"
OUT = pathlib.Path(r"C:\Users\alkorn\repos\fabric-empires\media\treasure-scenes")
